...
//separates the word from its definition
...
//separate the content of the buffer, line by line and pass it as a parameter to the line2word
...
//loads the contents of the file into a variable to use as a parameter in the parse
